...
try:
    ...
    from pytorch_transformers.modeling_bert import BertIntermediate, BertOutput, BertAttention, BertLayerNorm, BertSelfAttention


class SetDecoder(nn.Module):
    def __init__(self, config, num_generated_triplets, num_layers, num_classes, return_intermediate=False):
        super().__init__()
