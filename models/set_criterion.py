...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        #     num_triplets = len(targets[i]["relation"])
        #     tmp = torch.as_tensor(range(num_triplets), dtype=torch.int64)
    ...
    def relation_loss(self, outputs, targets, indices):
        ...
        """
        src_logits = outputs['pred_rel_logits'] # [bsz, num_generated_triplets, num_rel+1]
