...
## sciERC
```shell
python -m main --na_rel_coef 0.25 -- num_generated_triples 15 --max_grad_norm 5 --encoder_lr 1e-5 --decoder_lr 1e-5 --batch_size 2 --max_epoch 100 --num_decoder_layers 3 --lr_decay 0.01 --weight_decay 1e-5
```
